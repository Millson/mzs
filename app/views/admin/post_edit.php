...
<div class="container">
	<?php echo form_open('admin/post/publish', array('class'=>'well'), $this->hidden); ?>
	<div class="row">
		<div class="span8">
		...
		<div class="span3">
			...
			<?php echo form_multiselect('category[]', $this->categories, isset($this->category_select)?$this->category_select:'23'); ?>

			<?php echo form_label('标签', 'tags'); ?>
			<?php echo form_input(array('value'=>isset($this->tags)?$this->tags:'', 'name'=>'tags', 'id'=>'tags', 'placeholder'=>'输入标签')); ?>
